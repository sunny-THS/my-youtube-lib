...
class ChannelClient {
  ...
  Future<ChannelUploadsList> getUploadsFromPage(dynamic channelId,
    ...
    // List<Video> lstVideo = [];
    // for (var video in page.uploads) {
    //   lstVideo.add(Video(
    //     video.videoId,
    //     video.videoTitle,
    //     channel.title,
    //     channelId,
    //     video.videoUploadDate.toDateTime(),
    //     video.videoUploadDate,
    //     null,
    //     '',
    //     video.videoDuration,
    //     ThumbnailSet(video.videoId.value),
    //     null,
    //     Engagement(video.videoViews, null, null),
    //     false,
    //   ));
    // }
  ...
  Future<List<Playlist>> getPlaylistsFromPage(dynamic channelId) async {
    channelId = ChannelId.fromString(channelId);
